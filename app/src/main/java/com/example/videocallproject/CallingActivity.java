...
public class CallingActivity extends AppCompatActivity
{
    ...
    private ImageView acceptCall, cancelCall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactName = findViewById(R.id.username_call);
        profileImage = findViewById(R.id.image_profile_call);
    ...
    private void getAndsetUsersInfo()
    {
        usersRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                //jika receiverUserId exist atau ada, maka data user akan diambil oleh method ini
                // untuk ditampilkan
                if (dataSnapshot.child(receiverUserId).exists())
                {
                    ...
                    //.placeholder(R.drawable.profile_image) digunakan untuk menampilkan image default saat menunggu database
                    //mengaambil dan menampilkan foto profil yang asli.
                }

                //jika id pengirim ada maka akan ditampilkan informasinya saat penerima melihat siapa yg menelpon
    ...
    {
        //membatalkan telpon oleh sender atau penelpon
        ...
        //membatalkan telpon oleh pihak penerima atau receiver
